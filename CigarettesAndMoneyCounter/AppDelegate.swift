...
//'configure(withApplicationID:)' is deprecated: Use [GADMobileAds.sharedInstance startWithCompletionHandler:]
            ...
            do {
                ...
                for files in documents {
                    ...
                    do {
                        ...
                        try (urlForm as NSURL).setResourceValue(NSNumber(value: true as Bool), forKey: URLResourceKey.isExcludedFromBackupKey)
                    } catch {
        ...
        coreDataReasonsEntityInit(defaults.loadUserDefaults())
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.rs..SampleCoreData" in the
        //horou application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CigaretteRecord", withExtension: "momd")
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("CigarettesAndMoneyCounter.sqlite")
